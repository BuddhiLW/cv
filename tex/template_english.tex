...
\cvjobtitle{Engineering Physicist \&\\ Software Developer} % Job title/career
...
\cvmail{pedrogbranquinho@gmail.com | pedro.branquinho@usp.br} % Email address
...
\skills{{Linux/5.0},{Front-end/4.5},{Back-end/4.5},{Scripting/4.5}, {DevOps/4.0}, {Data Science/3.0}, {Theoretical Computer Science/3.0}}
...
\begin{twenty} % Environment for a list with descriptions
  \twentyitem{2016 - 2022}{Graduation}{\normalsize{São Paulo University, USP}}{Engineering Physics}
  \twentyitem{2023 - 2024}{MBA}{\normalsize{Faculdade Full Cycle de Tecnologia, FCTECH}}{Software Engineering}
...
\twentyitem{2024}{Orasis Holding - Jun/2024}{Developer}{
  SAGA pattern using Go. Modeling and architecting highly performant and scaling solution with a microsservices-focused design. Among the technologies used, RedPandas (Kafka), Cadence, Prometheus, Grafana, PostgreSQL, Postman, Swagger, REST APIs and gRPC.
}
...
\begin{twenty} % Environment for a list with descriptions
  ...
  \twentyitem{2017}{Ubuntu Linux}{First Install}{My objective
    was to use Emacs, which does not run smoothly on Windows.}
\end{twenty}
