...
\cvsite{\href{www.buddhilw.com}{\color{violet!60!black}www.buddhilw.com}} % Personal website
...
\aboutme{I have interests in the areas of applied scientific
  programming, a passion of which I developed in my
  graduation. Regarding science, I study the intersection of
  Statistics and Differential Equations and numerical tools.
  The Open Source movement has changed my life, in regard to the
  relashionship to computers.
  I heavily use the fruits of this enterprise, and I participate in the community. I'm
  also a member of the ACM, Association for Computing Machinery.}
...
\skills{{Emacs/5.7},{LaTeX/5.7},{Python/4.5},{Julia/4.5},{Clojure and
    ClojureScript/4.5}, {Scripting (Bash, et al.)/3}, {Git/3}, {R/2}}
