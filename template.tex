...
\aboutme{Indentifico-me com as área de pro-
  ...
  (Arch)Linux, e o movimento \textit{Open Source}. Já tive diversas experiências empregatíceas na área de automação administrativa, utilizando-se uma diversidade de stacks.}
...
\skills{{Emacs/5.7},{LaTeX/5.0}, {Bash/5.0}, {Python/4.5},{Julia/4.0},{Clojure e
    ClojureScript/4.0}, {R/4}, {Git/4},{Elm/1}}
...
\begin{twenty} % Environment for a list with descriptions
  ...
  \twentyitem{2021-2022}{\textit{USP}}{Estágio}{Pesquisa em modelos diferenciais de tráfego de carros}
  \twentyitem{2021}{\textit{USP}}{Mentoria}{Mentoria de estatística multivariada}
  \twentyitem{2021}{\textit{Lupo S.A.}}{Estágio}{Automação de relatórios}
  \twentyitem{2021}{\textit{Flow Finance, SC}}{Estágio}{Automação de geração de boletos}
