...
\leftheader{%
	{\LARGE\bfseries\sffamily Pedro Gomes Branquinho, B.Sc}

	\makefield{\faEnvelope[regular]}{\href{mailto:pedrogbranquinho@gmail.com}{\color{blue!50!violet}\texttt{pedrogbranquinho@gmail.com}}}

	% \makefield{\faTwitter}{\href{https://twitter.com/overleaf_example}{\texttt{@overleaf\_example}}}

	\makefield{\faLinkedin}{\href{https://www.linkedin.com/in/pedro-g-branquinho/}{\color{blue!50!violet}\texttt{pedro-g-branquinho}}}

	%% Next line
	\makefield{\faGlobe}{\href{https://www.buddhilw.com/pages-output/web-dev/}{\color{blue!50!violet}buddhilw.com}}
    \makefield{\faFile}{\href{https://www.buddhilw.com/pdf/cv-2024-02-21.pdf}{\color{blue!50!violet}\texttt{CV for humans - not ATS-optimized}}}
